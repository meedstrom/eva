...
The next section is written with the realtime model in mind, but much can apply to the past-classification model as well.  For discussion, see [[https://github.com/meedstrom/eva/issues/4][Issue #4]].
